...
public record AlumnoResponse(
        @Schema(description = "ID del maestro",
                example = "1")
        Long id,

        @Schema(description = "Nombre completo del maestro",
                example = "Miguel")
        String nombre,
        ...
        @Schema(description = "Matricula del maestro",
                example = "ROALCA2601")
        String matricula,

        @Schema(description = "Fecha de ingreso del maestro",
                example = "12/09/2026")
        String fechaIngreso,
        ...
        @Schema(description = "Promedio del alumno",
                example = "9.9")
        BigDecimal promedio
